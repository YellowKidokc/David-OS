...
8. In the chat workspace, use the right-side **Conversation OS** rail to save the current project/objective, preview arrivals, invite an agent under an explicit context/response contract, create a branch, or generate a re-entry packet.
