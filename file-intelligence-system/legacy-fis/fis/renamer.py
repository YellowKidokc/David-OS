...
from fis.fmeta import rename_fmeta_with_file, append_history
...
def rename_file(old_path: str, new_name: str, file_id: int):
    ...
    # Move .fmeta sidecar with the file
    try:
        rename_fmeta_with_file(str(old), new_name)
    except Exception:
        pass  # Don't let fmeta failures break rename
